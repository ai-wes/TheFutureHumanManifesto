    ...
    if not os.path.exists(INPUT_JSON_FILE):
        ...
        dummy_data = [
            ...
            },
            {
                "id": "dummy_2",
                "timeline": "2040-2050",
                "key_events": ["Fusion power achieved", "Global peace treaty"],
                "technological_factors": ["Fusion energy", "Advanced diplomacy tech"],
                "social_factors": ["Post-scarcity society", "Planetary consciousness"],
                "economic_factors": ["Decentralized economy", "Automated luxury communism"],
