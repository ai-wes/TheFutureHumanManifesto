...
try:
    from models import ScenarioGenome, Domain as DomainEnum # Assuming Domain is an Enum
except ImportError:
...
if __name__ == "__main__":
    ...
    num_synthetic_scenarios_to_generate = config.get("gapse_settings.training.synthetic_data_size", 1000) # Add to config
