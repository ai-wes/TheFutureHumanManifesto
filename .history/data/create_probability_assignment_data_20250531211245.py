...
Scenario Brief:
Timeline: {Extracted or implied from turning points, e.g., "2025-2049"}
...
- Driver: {tech_driver_1}
  Implication: {tech_implication_1}
...

Defining Social Dynamics & Implications:
- Dynamic: {social_dynamic_1}
  Implication: {social_implication_1}
...

Key Economic Transformations & Implications:
- Transformation: {economic_transformation_1}
  Implication: {economic_implication_1}
...
...
1.  Provide a "Plausibility Score" for this scenario occurring as described, on a scale from 0.0 (highly implausible, self-contradictory, or fantastical) to 1.0 (highly plausible, coherent, and a well-reasoned possibility for the future).
...
Output ONLY a JSON object with the following keys:
{
  ...
  "reasoning": "Your brief reasoning here."
    ...
    Please output the JSON in the specified format ONLY, nothing else.
"""
