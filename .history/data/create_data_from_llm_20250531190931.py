...
# --- File Paths ---
INPUT_JSON_FILE = "synthetic_scenarios_dataset.json"
...
def get_chat_completion(system_prompt_content, scenario_id):
    """
    Submits the prompt to the local API (http://0.0.0.0:1234/v1/chat/completions).
        ...
        try:
            ...
            payload = {
                ...
                "messages": [
                    ...
                    {"role": "user", "content": "Please output the JSON in the specified format ONLY."}
                ],
...
def main():
    ...
    for i, scenario_obj in enumerate(input_scenarios):
        ...
        if raw_llm_output:
            try:
                refined_data = json.loads(raw_llm_output)
                output_item = {
