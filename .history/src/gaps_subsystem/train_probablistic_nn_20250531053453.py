...
try:
    ...
    from src.gapse_subsystem.evolutionary_scenario_generator import ScenarioGenome

# ProbabilisticNN should be defined in hybrid_probabilistic_forecaster
from src.gapse_subsystem.hybrid_probabilistic_forecaster import ProbabilisticNN
...
HISTORICAL_DATA_PATH = config_loader.get("gapse_settings.training.historical_data_path", "data/historical_predictions_labeled.json")
    ...
    try:
        ...
        for item_dict in data_list:
            ...
            genome = ScenarioGenome(
                ...
                domains_focused=item_dict.get('domains_focused', []), # Ensure this key exists in JSON or ScenarioGenome handles default
